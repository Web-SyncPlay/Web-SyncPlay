...
import { type ClientToServerEvents, type ServerToClientEvents } from "~/lib/socket"
import {
  decUsers,
  deleteRoom,
  getRoom,
...
import { type Playlist, type RoomState, type UserState } from "~/lib/types"
